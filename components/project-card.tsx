...
export function ProjectCard({ project, delay = 0 }: ProjectCardProps) {
  ...
  return (
    <AnimatedSection delay={delay} className="project-card group flex flex-col h-full">
      {/* Image */}
        ...
        {!imgError ? (
          ...
          <div className="w-full h-full grid place-items-center bg-[var(--surface-soft)] text-[var(--muted-2)]">
            <div className="text-center p-6">
              <div className="mx-auto mb-2 h-8 w-8 rounded-full bg-white border border-[var(--border)] grid place-items-center">
      ...
      <div className="project-content">
        ...
        <h3 className="font-display text-[22px] font-semibold leading-[1.15] tracking-tight text-[var(--foreground)]">
          {project.name}
        </h3>
